...
for (row in 1:nrow(mean_hour_table)) {
  if (mean_hour_table[row, "order_dow"] == 0) {
    mean_hour_table[row, "order_dow"] = "Sunday"
  }
  if (mean_hour_table[row, "order_dow"] == 1) {
    mean_hour_table[row, "order_dow"] = "Monday"
  }
  if (mean_hour_table[row, "order_dow"] == 2) {
    mean_hour_table[row, "order_dow"] = "Tuesday"
  }
  if (mean_hour_table[row, "order_dow"] == 3) {
    mean_hour_table[row, "order_dow"] = "Wednesday"
  }
  if (mean_hour_table[row, "order_dow"] == 4) {
    mean_hour_table[row, "order_dow"] = "Thursday"
  }
  if (mean_hour_table[row, "order_dow"] == 5) {
    mean_hour_table[row, "order_dow"] = "Friday"
  }
  if (mean_hour_table[row, "order_dow"] == 6) {
    mean_hour_table[row, "order_dow"] = "Saturday"
  }
}
